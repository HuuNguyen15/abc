                        ...
                        <div class="login-form">
                            <form action="{{route('admin-dashboard')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="admin_email" placeholder="Điền email">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="admin_password" placeholder="Điền mật khẩu">
                                </div>
