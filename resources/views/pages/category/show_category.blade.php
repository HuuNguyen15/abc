            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb-list">
                        ...
                        @foreach($cate_name as $key=> $title)
                        <li class="breadcrumb-item active">Thương hiệu {{$title->category_name}}</li>
                        @endforeach
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="sidebar-categores-box">
                        <div class="sidebar-title">
                            <div class="blog-sidebar mb--30">
                                <h4 class="title">Danh mục sản phảm</h4>
                                <ul>
                                    @foreach($cate_product as $key => $cate)
                                        <li><a href="{{url('danh-muc-san-pham/'.$cate->category_slug)}}">{{$cate->category_name}} <span>{{$cate->category_count}}</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-categores-box">
                        <div class="sidebar-title">
                            <div class="blog-sidebar mb--30">
                                <h4 class="title">Thương hiệu sản phảm</h4>
                                <ul>
                                    @foreach($brand_product as $key => $brand)
                                        <li><a href="{{url('thuong-hieu-san-pham/'.$brand->brand_slug)}}">{{$brand->brand_name}} <span>{{$brand->brand_count}}</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                    </div>
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    ...
                                                    <div class="quick_view">
                                                        <a href="{{url('chi-tiet-san-pham/'.$product->slug.'/'.$product->product_id)}}" title="quick view" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-search"></i></a>
                                                    </div>
                                                </div>
                                                <div class="product-content">
                                                    ...
                                                    <form >
                                                       ...
                                                       <div class="product-action">
                                                        <button class="add-to-cart" title="Add to cart" data-id_product="{{$product->product_id}}"><i class="fa fa-plus"></i> Thêm giỏ hàng</button>
                                       ...
                                       @foreach($category_by_id as $product)
                                        <div class="row product-layout-list">
                                            <div class="col-lg-4 col-md-5">
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a  class="set_image" href="{{url('chi-tiet-san-pham/'.$product->slug)}}"><img  src="{{url('public/uploads/product/'.$product->product_image)}}" alt=""></a>
                                                        <span class="label-product label-new">new</span>
                                                        <span class="label-product label-sale">-7%</span>
                                                        <div class="quick_view">
